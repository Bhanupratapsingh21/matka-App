        ...
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <h1 className="text-xl font-semibold text-gray-800 mb-6">Customer Sell Report</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                        ...
                        <Button onClick={handleClear} variant="destructive" className="bg-red-500 hover:bg-red-600 text-white px-8">
                            CLEAR
                        </Button>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <h2 className="text-lg font-semibold text-gray-800 mb-4">Single Digit</h2>

                    <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                            <thead>
                                <tr className="bg-gray-50">
                                    <th className="border border-gray-300 px-4 py-3 text-center font-medium text-gray-700">Digit</th>
                                    {singleDigits.map((digit) => (
                                        <th key={digit} className="border border-gray-300 px-4 py-3 text-center font-medium text-gray-700">
                                            {digit}
                                        </th>
                                    ))}
                                </tr>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    {singleDigits.map((digit) => (
                                        <td key={digit} className="border border-gray-300 px-4 py-3 text-center">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                            <tbody>
                                ...
                                <tr className="bg-gray-50">
                                    <td className="border border-gray-300 px-4 py-3 text-center font-medium text-gray-700">Digit</td>
                                    {pannaNumbers[0].map((num) => (
                                        <td key={num} className="border border-gray-300 px-4 py-3 text-center font-medium text-gray-700">
                                            {num}
                                        </td>
                                    ))}
                                </tr>
                                <tr>
                                    ...
                                    {pannaNumbers[0].map((num) => (
                                        <td key={num} className="border border-gray-300 px-4 py-3 text-center">
                                            <span className="inline-flex items-center justify-center w-6 h-6 bg-red-500 text-white text-sm rounded-full">
                                                0
                                            </span>
                                        </td>
                                ...
                                {pannaNumbers.slice(1).map((row, rowIndex) => (
                                    <tr key={`row-${rowIndex}`}>
                                        {row.map((num) => (
                                            <td key={num} className="border border-gray-300 px-4 py-3">
                                                <div className="text-center">
                                                    <div className="font-medium text-gray-700 mb-1">{num}</div>
                                                    <span className="inline-flex items-center justify-center w-6 h-6 bg-red-500 text-white text-sm rounded-full">
                                                        0
                                                    </span>
                                                </div>
                                        ...
                                        {row.length < 12 &&
                                            Array.from({ length: 12 - row.length }).map((_, emptyIndex) => (
                                                <td
