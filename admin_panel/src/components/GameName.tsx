    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            games.map((game, idx) => (
                ...
                Edit
>>>>>>> 9ba3c9254686d6b138f47cd6501bd30812dc9e3f:admin_panel/src/components/starline/GameName.tsx
                </button>
                <button
            ...
            {game.status === "Active" ? "Inactive" : "Active"}
                    ...
                    <button className="px-3 py-1 text-xs rounded border border-blue-600 text-blue-600">
                      Delete
                      </button>
                      </div>
                      </td>
                    ...
                    <div className="fixed right-0 top-0 w-full max-w-md h-full bg-white shadow-lg z-50 overflow-y-auto p-6">
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setNewGame({ ...newGame, nameHindi: e.target.value })
                                }
                            />
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setNewGame({ ...newGame, openTime: e.target.value })
                                }
                            />
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setNewGame({ ...newGame, closeTime: e.target.value })
                                }
                            />
                        </div>
